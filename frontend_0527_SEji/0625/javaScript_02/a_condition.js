...
// 조건문의 종류 : if, else if (if)문, if-else문, switch문
...
// } else {
//   console.logo("number2 is not positive");
// }
...
// if문과 else문 사잉에 위치, 여러 개의 조건을 확인할 수 있게 해주는 제어 구조
...
//   console.log("The number is positive");
// } else if (number3 < 0) {
//   console.logo("The number is negative");
// } else {
...
//     break; // break문을 만나면 switch문을 빠져나온다.
//   case "apple":
...
// 그 결과가 true 이면 표현식1을, false이면 표현식2를 실행. else (if)문의 로직과 동일
...
// 두 조건이 true 일 경우 1개만 true일 경우처럼 여러 경우의 수를 따질 때는 논리 연산자를 사용

//? OR 연산자
// 피여산자 2개 중에서 true가 하나라도 있으면 결과값은 true
...
if (numberOne < 10 || numberTwo < 10) alert('숫자 2개 중에서 최소한 하나는 10 미만입니다.');
else alert('숫자 2개 중에서 10미만인 수가 없습니다.');



//? AND 연산자
// 피연산자 2개 중에서 false가 하나라도 있으면 결과값이 false
...
// 첫 번째 조건을 보고 빠르게 판단할 수 있도록 로직을 구성해야 합니다.

((x === 10) && (y === 20))

// AND 연산자 : 첫 번째 조건식에 fasle가 될 확률이 높은 조건을 사용하는 것이 좋다.
// OR 연산자 : 첫 번째 조건식에 true가 될 확률이 높은 조건을 사용하는 것이 좋다.