...
//? 02. 사용자 입력 받기
// do 실행문 시작 전에 userInput 변수를 선언해주세요.
// do 실행 코드 블럭에 사용자로부터 숫자를 입력 받아 userInput 변수에 할당해주세요.
// 사용자가 10보다 큰 숫자를 입력할 때 까지 계속해서 입력을 요청합니다.
...
// 처음이 거짓인 경우에도 한 번은 실행된다! 무한루프 주의하기
